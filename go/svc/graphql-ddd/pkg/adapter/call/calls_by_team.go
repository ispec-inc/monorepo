...
func (a Adapter) CallsByTeam(ctx context.Context, args CallsByTeam) (*resolver.CallConnection, error) {

	list := uc.NewListByTeam(a.registry)
	ipt := uc.ListByTeamInput{
		//FIXME User ID
		UserID: 1,
	}
	opt, err := list.Do(ipt)
